...
public class AesCbcWithIntegrity {
    ...
    public static final int BASE64_FLAGS = 1;
    //default for testing
     ...
     */
    public static CipherTextIvMac encryptString(String plaintext, SecretKeys secretKeys)
            throws UnsupportedEncodingException, GeneralSecurityException {
        return encryptString(plaintext, secretKeys, "UTF-8");
    }
     ...
     */
    public static CipherTextIvMac encryptString(String plaintext, SecretKeys secretKeys, String encoding)
            throws UnsupportedEncodingException, GeneralSecurityException {
